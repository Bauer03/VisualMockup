export const createOutputContent = () => {
    ...
    const basicTab = content.querySelector('#basic-tab');
    const energyTab = content.querySelector('#energy-tab');
    const basicContent = content.querySelector('#basic-content');
    const energyContent = content.querySelector('#energy-content');
